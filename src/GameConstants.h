...
constexpr const int BOARD_OFFSET = 133;              // 3. ¡Clave! Centra el tablero 4:3 dentro de los 1067 píxeles ((1067-800)/2)
constexpr const int BOARD_EDGE = -133;              // 4. Ajusta el límite izquierdo para los zombis que entran
constexpr const int BOARD_IMAGE_WIDTH_OFFSET = 1067; // 5. Ajusta el ancho de la imagen de fondo
